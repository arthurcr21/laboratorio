...
const PreviewCell: React.FC<PreviewCellProps> = ({ 
  ...
  return (
    <td 
      ...
      style={isAnonymized ? { color: 'var(--color-accent-cyan)', background: 'rgba(6, 182, 212, 0.02)' } : {}}
    >
      {loading ? (
          ...
          <table className="preview-table">
            <thead>
              <tr>
                ...
                <th style={{ width: '65px', minWidth: '65px', background: '#0b0f19', textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.8rem' }}>
                  Ativar
                </th>
