      ...
      <div className="app-header-wrapper">
        <header className="app-header">
          <div className="header-brand">
            <div style={{ display: 'flex', alignItems: 'baseline', fontFamily: 'Inter, sans-serif', letterSpacing: '-0.03em', color: 'var(--color-primary)', userSelect: 'none', fontWeight: 900 }}>
              <span style={{ fontSize: '1.8rem' }}>BRASILCAP</span>
            </div>
            <div className="header-divider"></div>
            <div className="header-title-container">
              <h1 className="header-title">Anonimizador de Planilhas</h1>
              <p className="header-subtitle">Segurança da Informação | LGPD</p>
            </div>
          </div>
          <div className="header-meta">
            <span className="badge-lgpd badge-lgpd-header">
              <ShieldCheck size={14} />
          ...
          {!file ? (
            <div>
              ...
              <div className="hero-section">
                <h2 className="hero-title">Anonimizador de Planilhas</h2>
                <p className="hero-subtitle">
                  Proteja dados pessoais sensíveis de clientes e colaboradores de forma simples e segura.
                  As planilhas são processadas localmente na memória do seu navegador web — nenhum dado sai do seu computador.
                </p>
              </div>
              ...
              <div style={{ 
                ...
                <div className="glass-panel" style={{ padding: '1.5rem', position: 'relative' }}>
                  <div style={{ color: 'var(--color-primary)', background: 'rgba(0, 56, 168, 0.05)', padding: '0.6rem', borderRadius: '8px', display: 'inline-flex', marginBottom: '1rem', border: '1px solid rgba(0, 56, 168, 0.1)' }}>
                    <Lock size={20} />
                  </div>
                  <h4 style={{ fontSize: '1.05rem', fontWeight: '700', marginBottom: '0.5rem', color: 'var(--color-primary)' }}>Segurança Absoluta</h4>
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                    Em conformidade com a LGPD e políticas corporativas do BB. Seus arquivos de trabalho não são enviados a servidores externos.
                  </p>
                </div>

                <div className="glass-panel" style={{ padding: '1.5rem' }}>
                  <div style={{ color: 'var(--color-accent-cyan)', background: 'rgba(0, 115, 230, 0.05)', padding: '0.6rem', borderRadius: '8px', display: 'inline-flex', marginBottom: '1rem', border: '1px solid rgba(0, 115, 230, 0.1)' }}>
                    <Sparkles size={20} />
                  </div>
                  <h4 style={{ fontSize: '1.05rem', fontWeight: '700', marginBottom: '0.5rem', color: 'var(--color-primary)' }}>Regras por Tipo de Dado</h4>
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                    Configure de forma rápida e inteligente regras diferentes para dados numéricos (perturbados/generalizados) e textuais (fictícios/mascarados).
                  </p>
                </div>

                <div className="glass-panel" style={{ padding: '1.5rem' }}>
                  <div style={{ color: 'var(--color-accent-green)', background: 'rgba(0, 135, 90, 0.05)', padding: '0.6rem', borderRadius: '8px', display: 'inline-flex', marginBottom: '1rem', border: '1px solid rgba(0, 135, 90, 0.1)' }}>
                    <HardDrive size={20} />
                  </div>
                  <h4 style={{ fontSize: '1.05rem', fontWeight: '700', marginBottom: '0.5rem', color: 'var(--color-primary)' }}>Preservação do Formato</h4>
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                    Mantém fórmulas, estilos e estrutura original das abas das planilhas. Suporta arquivos .xlsx, .csv, .xls e .ods de forma transparente.
                  </p>
                </div>
            ...
            <div>
              {/* File details bar */}
              <div className="file-info-bar" style={{ flexWrap: 'wrap', gap: '1rem' }}>
                ...
                {sheetNames.length > 1 && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: '#f8fafc', padding: '0.4rem 0.8rem', border: '1px solid var(--border-color)', borderRadius: '6px' }}>
