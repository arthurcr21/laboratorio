  ...
  return (
    <div className="glass-panel" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="card-body" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        {/* Statistics Banner */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(0, 56, 168, 0.05)', border: '1px solid rgba(0, 56, 168, 0.15)', padding: '0.75rem 1rem', borderRadius: '8px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', background: '#f8fafc', padding: '0.75rem', border: '1px solid var(--border-color)', borderRadius: '8px' }}>
